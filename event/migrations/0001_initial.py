# Generated by Django 4.2.6 on 2024-03-08 23:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.URLField(blank=True, default='', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('band_camp', models.URLField(blank=True, default='')),
                ('link_tree', models.URLField(blank=True, default='')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug_venue', models.ManyToManyField(blank=True, to='event.slug')),
            ],
        ),
        migrations.CreateModel(
            name='Event',
            fields=[
                ...
                ('buyUrl', models.URLField(blank=True, default='')),
        ...
        migrations.AddField(
            model_name='artist',
            name='spotify',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='event.spotify'),
        ),
    ]
